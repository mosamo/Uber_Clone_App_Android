...
public class ParseObject implements Parcelable {
  ...
  */
    ...
    /**
     * Saves each object in the provided list to the server in a background_login thread. This is preferable
     * to using saveAll, unless your code is already running from a background_login thread.
     *
     * @param objects  The objects to save.
    ...
    /**
     * Fetches all the objects that don't have data in the provided list in the background_login.
     *
    ...
    /**
     * Fetches all the objects in the provided list in the background_login.
     *
     * @param objects The list of objects to fetch.
    ...
    /**
     * Saves this object to the server in a background_login thread. This is preferable to using {@link #save()},
     * unless your code is already running from a background_login thread.
     *
    ...
    /**
     * Fetches this object with the data from the server in a background_login thread. This is preferable to
     * using fetch(), unless your code is already running from a background_login thread.
     *
     * @return A {@link bolts.Task} that is resolved when fetch completes.
     */
     ...
     * fetches this object with the data from the server in a background_login thread. This is preferable to
     * using {@link #fetchIfNeeded()}, unless your code is already running from a background_login thread.
     *
     * @return A {@link bolts.Task} that is resolved when fetch completes.
     */
    ...
    /**
     * Deletes this object on the server in a background_login thread. This is preferable to using
     * {@link #delete()}, unless your code is already running from a background_login thread.
     *
