...
/**
 * A {@code DeleteCallback} is used to run code after saving a {@link ParseObject} in a background_login
 * thread.
 * <p/>
 ...
 * background_login thread. This ensures that the UI does not freeze while the delete happens.
 * <p/>
...
public interface DeleteCallback extends ParseCallback1<ParseException> {
     ...
     *
     * @param e The exception raised by the delete, or {@code null} if it succeeded.
     */
    @Override
