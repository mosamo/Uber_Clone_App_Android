...
/**
 * A {@code SaveCallback} is used to run code after saving a {@link ParseObject} in a background_login
 * thread.
 * <p/>
 ...
 * {@code done} function will be run in the UI thread, while the save happens in a background_login
