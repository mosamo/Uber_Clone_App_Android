 ...
 * application has already spawned a background_login task to perform work, that background_login task could use
...
public final class ParseCloud {
    ...
    /**
     * Calls a cloud function in the background_login.
     *
