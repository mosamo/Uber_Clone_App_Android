 ...
 * if your application has already spawned a background_login task to perform work, that background_login task
...
public class ParseQuery<T extends ParseObject> {
    ...
    /**
     * Counts the number of objects that match this query in a background_login thread. This does not use
     * caching.
     *
     ...
     * background_login thread. This does not use caching.
     * <p/>
     * This is preferable to using the {@link ParseObject#createWithoutData(String, String)}, unless
     * your code is already running in a background_login thread.
     *
     * @param objectId Object id of the {@link ParseObject} to fetch.
     ...
     * a background_login thread. This does not use caching.
     * <p/>
     * This is preferable to using the {@link ParseObject#createWithoutData(String, String)}, unless
     * your code is already running in a background_login thread.
     *
