...
/**
 * A {@code SendCallback} is used to run code after sending a {@link ParsePush} in a background_login
 * thread.
 * <p/>
 ...
 * {@code done} function will be run in the UI thread, while the send happens in a background_login
