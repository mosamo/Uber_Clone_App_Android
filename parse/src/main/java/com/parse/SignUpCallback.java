...
/**
 * A {@code SignUpCallback} is used to run code after signing up a {@link ParseUser} in a background_login
 * thread.
 * <p>
 ...
 * {@code done} function will be run in the UI thread, while the signup happens in a background_login
