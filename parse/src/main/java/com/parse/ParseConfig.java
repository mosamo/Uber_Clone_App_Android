...
public class ParseConfig {
    ...
    /**
     * Fetches a new configuration object from the server in a background_login thread. This is preferable
     * to using {@link #get()}, unless your code is already running from a background_login thread.
     *
